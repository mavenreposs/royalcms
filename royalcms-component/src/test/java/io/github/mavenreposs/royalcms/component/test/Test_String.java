package io.github.mavenreposs.royalcms.component.test;

import io.github.mavenreposs.royalcms.component.facades.RC_Log;
import io.github.mavenreposs.royalcms.component.facades.RC_String;
...
public class Test_String {
    ...
    public void test_lower() {
        ...
        RC_Log.info(a);
        assertEquals("dscmall", a);

        String b = RC_String.of("DSCMALL").lower().toString();
        RC_Log.info(b);
        assertEquals("dscmall", b);
    }
    ...
    public void test_replaceArray() {
        ...
        assertEquals("The event will take place between 8:30 and 9:00", replaced);

        String b = RC_String.of(string).replaceArray("?", new String[]{"8:30", "9:00"}).toString();
        RC_Log.info(b);
        assertEquals("The event will take place between 8:30 and 9:00", b);
    }
    ...
    public void test_replaceFirst() {
        ...
        RC_Log.info(replaced);
        assertEquals("a quick brown fox jumps over the lazy dog", replaced);

        String b = RC_String.of("the quick brown fox jumps over the lazy dog").replaceFirst("the", "a").toString();
        RC_Log.info(b);
        assertEquals("a quick brown fox jumps over the lazy dog", b);
    }
    ...
    public void test_replaceLast() {
        ...
        RC_Log.info(replaced);
        assertEquals("the quick brown fox jumps over a lazy dog", replaced);

        String b = RC_String.of("the quick brown fox jumps over the lazy dog").replaceLast("the", "a").toString();
        RC_Log.info(b);
        assertEquals("the quick brown fox jumps over a lazy dog", b);
    }
    ...
    public void test_title() {
        ...
        assertEquals("A Nice Title Uses The Correct Case", converted);

        String b = RC_String.of("a nice title uses the correct case").title().toString();
        RC_Log.info(b);
        assertEquals("A Nice Title Uses The Correct Case", b);
    }
